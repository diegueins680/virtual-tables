...
class HTMLPurifier_Encoder
{
    ...
    public static function convertFromUTF8($str, $config, $context) {
        $encoding = $config->get('Core.Encoding');
        if (($escape = $config->get('Core.EscapeNonASCIICharacters')) != false)
        {
...
class HTMLPurifier_ErrorCollector
{
    ...
    private function _renderStruct(&$ret, $struct, $line = null, $col = null) {
        ...
        while (($current = array_pop($stack))!= false)
        {
...
class HTMLPurifier_AttrDef_CSS_FontFamily extends HTMLPurifier_AttrDef
{
    ...
    public function validate($string, $config, $context) {
        ...
        foreach($fonts as $font) {
            ...
            //    major browsers, for example: "ï¼­ï¼³ æ˜Žæœ�" is a
            //    legitimate font-name
            //    <http://ja.wikipedia.org/wiki/MS_æ˜Žæœ�>.  See
            //    the CSS3 spec for more examples:
            //    <http://www.w3.org/TR/2011/WD-css3-fonts-20110324/localizedfamilynames.png>
            //    You can see live samples of these on the Internet:
            //    <http://www.google.co.jp/search?q=font-family+ï¼­ï¼³+æ˜Žæœ�|ã‚´ã‚·ãƒƒã‚¯>
    ...
    protected function tokenizeDOM($node, &$tokens) {
        ...
        do {
            ...
            if ($level && isset($closingNodes[$level])) {
                while(($node = array_pop($closingNodes[$level]))!= false) 
                {

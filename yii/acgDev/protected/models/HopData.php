 ...
 * @property integer $idhop_data_id
...
class HopData extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('customer_name_key, idcrrt', 'length', 'max'=>4),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('agent_id, idhop_data_id, util_type, program_code, sales_state, auth_fname, auth_mi, auth_lname, bill_fname, bill_mi, bill_lname, company_name, company_title, btn, serv_address, serv_city, serv_state, serv_zip, serv_county, bill_address, bill_city, bill_state, bill_zip, acct_type, acct_num, meter_num, rate_class, lead_type, customer_name_key, email_address, serv_ref_num, epod_id, tax_id, idcrrt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idcrrt',$this->idcrrt,true);
